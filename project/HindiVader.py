...
def hindiSenti(data):
    ...
    BOOSTER_DICT = \
        {"बिलकुल": B_INCR, "awfully": B_INCR,
         ...
         "चरम": B_INCR, "अत्यंत": B_INCR, "बेहद": B_INCR,
          "कमबख्त": B_INCR, "बहुत": B_INCR, "hella": B_INCR, "अत्यधिक": B_INCR, "बेहद": B_INCR,
    ...
    class SentimentIntensityAnalyzer(object):
        ...
        # reading lexicons emoji plus hindi
